...
- 提供当前关卡对象列表，可读取、写入选中对象坐标
- 提供“打开面前笼子”按钮与快捷键，会打开附近最近的未开启金属笼子
...
6. 在“对象坐标”页点击“刷新对象”，选中一个对象后可读取/写入它的坐标。
7. 站到金属笼子前，点击“打开面前笼子”或按 `Ctrl+Alt+5`。
...
如果需要在视频或者直播中使用或传播请标注作者 不是吴昊的wh
